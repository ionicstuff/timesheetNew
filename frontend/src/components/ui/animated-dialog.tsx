...
AnimatedDialogHeader.displayName = "DialogHeader";
...
AnimatedDialogFooter.displayName = "DialogFooter";
...
const AnimatedDialogDescription = React.forwardRef<
  ...
  React.ComponentPropsWithout0Ref<typeof DialogPrimitive.Description>
>(({ className, ...props }, ref) => (
