      ...
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div className="border rounded-lg p-3">
            ...
            <p className="text-2xl font-bold mt-1">{priorityData[0].total}</p>
          ...
          <div className="border rounded-lg p-3">
            ...
            <p className="text-2xl font-bold mt-1">{priorityData[1].total}</p>
            <p className="text-xs text-muted-foreground">
          ...
          <div className="border rounded-lg p-3">
            ...
            <p className="text-2xl font-bold mt-1">{priorityData[2].total}</p>
            <p className="text-xs text-muted-foreground">
