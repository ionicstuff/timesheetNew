  ...
  const handleAnalyze = () => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description:
          "We've optimized your task priorities based on deadlines and project importance.",
      });
    }, 3000);
  };
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-green-700 mt-1">
                  Based on your deadlines and project priorities, we recommend
                  the following task order:
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center justify-between p-3 bg-background border rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Product Launch • Due Dec 10
                  </p>
                </div>
              </div>
              <span
                className={`text-xs px-2 py-1 rounded-full ${getPriorityColor('High')}`}
              >
                High Priority
              </span>
            </div>
            ...
            <div className="flex items-center justify-between p-3 bg-background border rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Product Launch • Due Dec 12
                  </p>
                </div>
              </div>
              <span
                className={`text-xs px-2 py-1 rounded-full ${getPriorityColor('Medium')}`}
              >
                Medium Priority
              </span>
            </div>
            ...
            <div className="flex items-center justify-between p-3 bg-background border rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Marketing Campaign • Due Dec 20
                  </p>
                </div>
              </div>
              <span
                className={`text-xs px-2 py-1 rounded-full ${getPriorityColor('Low')}`}
              >
                Low Priority
              </span>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-700 mt-1">
                  Start with the client meeting as it's time-sensitive. Complete
                  the competitor research before the design work to inform your
                  decisions.
                </p>
              </div>
            </div>
          ...
          <div className="p-4 bg-muted rounded-lg">
            ...
            <ul className="text-sm space-y-2">
              ...
              <li className="flex items-start gap-2">
                ...
                <span>
                  Recommends optimal task order to maximize efficiency
                </span>
              </li>
              <li className="flex items-start gap-2">
          ...
          <div className="p-4 bg-primary/5 border border-primary/20 rounded-lg">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Our machine learning algorithms analyze thousands of task
                  completion patterns to provide you with the most effective
