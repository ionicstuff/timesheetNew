...
const AITaskScheduler = () => {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        const mockRecommendations: ScheduleRecommendation[] = currentTasks.map(
          (task, index) => ({
            taskId: task.id,
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-700 mt-1">
                      Based on your deadlines and project priorities, we
                      recommend the following task order:
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-700 mt-1">
                      Start with high-priority tasks that have approaching
                      deadlines. Consider task dependencies when scheduling your
                      day.
                    </p>
                  </div>
                </div>
              ...
              <div className="p-4 bg-muted rounded-lg">
                ...
                <ul className="text-sm space-y-2">
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      Analyzes your task deadlines and project priorities
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
