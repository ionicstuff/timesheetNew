...
const ProjectCalendar = ({ sprints }: ProjectCalendarProps) => {
  ...
  const renderCalendar = () => {
    ...
    for (let day = 1; day <= daysInMonth; day++) {
      ...
      const sprintsOnDay = sprints.filter(
        (sprint) =>
          (sprint.startDate.getDate() === day &&
            sprint.startDate.getMonth() === month &&
            sprint.startDate.getFullYear() === year) ||
          (sprint.endDate.getDate() === day &&
            sprint.endDate.getMonth() === month &&
            sprint.endDate.getFullYear() === year)
      );
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Your project sprints and deadlines</CardDescription>
      </CardHeader>
      <CardContent>
