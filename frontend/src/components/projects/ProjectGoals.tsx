    ...
    onGoalsChange(
      goals.map((goal) =>
        goal.id === id
          ? {
              ...goal,
              currentValue: Math.max(0, Math.min(goal.targetValue, value)),
            }
          : goal
      )
    );
      ...
      {goals.length === 0 ? (
        <div className="text-center py-8 text-muted-foreground">
          ...
          <p className="text-sm mt-1">
            Define measurable goals to track project success
          </p>
        </div>
      ) : (
              ...
              <div key={goal.id} className="border rounded-lg p-4">
                ...
                <div className="mt-3 flex items-center gap-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      updateCurrentValue(goal.id, Number(e.target.value))
                    }
                    className="h-8 w-24"
                  />
