...
const GoalTracker = () => {
  ...
  const achievements = [
    ...
    },
    {
      id: 2,
      title: 'Early Bird',
      description: 'Submitted 10 tasks ahead of schedule',
            ...
            {goals.map((goal) => (
              <div key={goal.id} className="space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  <span
                    className={
                      goal.color + ' px-2 py-1 rounded text-white text-xs'
                    }
                  >
        ...
        <CardContent>
          <div className="space-y-4">
            {achievements.map((achievement) => (
              ...
              >
                <div className="mt-0.5 text-yellow-500">{achievement.icon}</div>
                <div>
