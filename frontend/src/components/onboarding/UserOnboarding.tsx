              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <ul className="text-sm text-muted-foreground list-disc pl-5 mt-1 space-y-1">
                    <li>
                      Workspaces can be organized by company, department, or
                      project
                    </li>
                    <li>
                    ...
                    <li>
                      Each workspace has its own members, projects, and settings
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="border rounded-lg p-4">
                ...
                {team.members.length === 0 ? (
                  <p className="text-sm text-muted-foreground">
                    No members added yet. Add email addresses above to invite
                    them.
                  </p>
                ) : (
            ...
            <div className="p-4 bg-muted rounded-lg">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <ul className="text-sm text-muted-foreground list-disc pl-5 mt-1 space-y-1">
                    <li>
                      Team members can be invited to specific projects or the
                      entire workspace
                    </li>
