...
router.get('/', authorizeRoles('admin', 'hr', 'manager'), getAllUsers);
...
// @access  Private (HR, Admin, Manager)
router.get('/stats', authorizeRoles('admin', 'hr', 'manager'), getUserStats);
...
router.get('/team', authorizeRoles('admin', 'account manager', 'project manager'), getTeamMembers);
...
// @access  Private (HR, Admin)
router.post('/', authorizeRoles('admin', 'hr'), createUserValidation, createUser);
...
// @access  Private (HR, Admin)
router.delete('/:userId', authorizeRoles('admin', 'hr'), userIdValidation, deactivateUser);
